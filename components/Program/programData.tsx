...
const ProgramData: Program[] = [
  {
    ...
    body: [
      ...
      "We have also expanded our scholarship program to reach more students in need. By providing financial assistance and support, we are ensuring that every child has the opportunity to receive a quality education.",
      "These initiatives are part of our commitment to excellence and innovation in education. We believe that by investing in our students and providing them with the tools they need to succeed, we are shaping a brighter future for our community."
    ],
    additionalImages: [
      { src: "/images/about/ed.jpg", width: 350, height: 200, alt: "Classroom" },
      { src: "/images/about/ed2.jpg", width: 350, height: 200, alt: "Students" }
    ]
  },
  {
    _id: 2,
    ...
    metadata: "Our widow empowerment program has transformed the lives of women in our community.",
    mainImage: "/images/about/ed22.jpg",
    author: { name: "George Jarona", image: "/images/authors/gerald.jpg" },
    tags: ["Empowerment", "Change", "Journey"],
    category: "Success Stories",
    publishedAt: "June 20, 2024",
    body: [
      "At Brainstorm Junior, we believe in empowering women to create positive change in their lives and communities. Our widow empowerment program is designed to support widows through skills training, financial assistance, and emotional support.",
      "Many women in our community face significant challenges after the loss of their spouses. They may struggle to provide for their families, access education, or find employment. Our program aims to address these challenges and help widows build a brighter future for themselves and their children.",
      "Through skills training workshops, we equip widows with the knowledge and tools to start their own businesses or pursue employment opportunities. We also provide financial assistance to help them cover basic needs and invest in their ventures.",
      "Emotional support is a key component of our program, as we recognize the importance of mental health and well-being in the journey to empowerment. Our counselors and volunteers offer a listening ear, guidance, and encouragement to help widows navigate their challenges and build resilience.",]
      ,
    additionalImages: [
      { src: "/images/about/ed21.jpg", width: 350, height: 200, alt: "Student Success" },
      { src: "/images/about/ed22.jpg", width: 350, height: 200, alt: "Achievement" }
    ]
  },
  {
    _id: 3,
    ...
    additionalImages: [
      ...
      { src: "/images/blog/blog-07.jpg", width: 350, height: 200, alt: "Achievement" }
    ]
  },
  {
    _id: 4,
    title: "School Feeding Program",
    slug: "school-feeding-program",
    metadata: "Learn about Brainstorm Junior's school feeding program and its impact on student well-being.",
    mainImage: "/images/about/ed8.jpg",
    author: { "name": "George Jarona", "image": "/images/authors/gerald.jpg" },
    tags: ["Health", "Nutrition", "Well-being"],
    category: "Activities",
    publishedAt: "April 10, 2024",
    body: [
        "Brainstorm Junior's school feeding program is an essential component of our efforts to support student well-being and academic success. This program provides daily nutritious meals to students, ensuring they have the energy and nourishment needed to thrive in the classroom.",
        "Many of our students come from low-income families that struggle to provide regular meals. By offering free meals at school, we help alleviate hunger and malnutrition among our students, enabling them to focus on their studies and reach their full potential.",
        "In addition to addressing immediate nutritional needs, the school feeding program has long-term benefits for the students. Research has shown that access to nutritious meals can improve cognitive function, academic performance, and overall health. By investing in the well-being of our students, we are investing in their future.",
        "We are grateful to our donors and partners who support this program and make it possible for us to provide nutritious meals to our students. Together, we are making a difference in the lives of children and helping them build a foundation for success."],
    "additionalImages": [
        { "src": "/images/about/ed1.jpg", "width": 350, "height": 200, "alt": "Extracurricular Activities" },
        { "src": "/images/about/ed12.jpg", "width": 350, "height": 200, "alt": "School Feeding Program" }
    ]
},
  {
    _id: 5,
    ...
    mainImage: "/images/about/ed9.jpg",
    author: { name: "George Jarona", image: "/images/authors/gerald.jpg" },
    ...
    additionalImages: [
      { src: "/images/about/ed.jpg", width: 350, height: 200, alt: "Empowerment" },
      { src: "/images/about/ed.jpg", width: 350, height: 200, alt: "Support" }
    ]
  },
  {
    _id: 6,
    ...
    mainImage: "/images/blog/blog-09.jpg",
    author: { name: "George Jarona", image: "/images/authors/gerald.jpg" },
    ...
    additionalImages: [
      { src: "/images/blog/blog-09.jpg", width: 350, height: 200, alt: "Support Education" },
      { src: "/images/blog/blog-01.jpeg", width: 350, height: 200, alt: "Educational Support" }
    ]
  }
];
