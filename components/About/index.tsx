            ...
            >
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  ...
                  <p>Comprehensive educational programs tailored to the needs of children in Kibera.</p>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                <div className="flex h-15 w-15 items-center justify-center rounded-[50%] border border-stroke dark:border-strokedark dark:bg-blacksection">
                ...
                <div className="w-3/4">
                  ...
                  <p>Creating a nurturing and safe space where children can learn and grow.</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="mx-auto max-w-c-1235 overflow-hidden px-4 md:px-8 2xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <p>
                We believe in the power of community and engage in various outreach programs to support and uplift the children and families in Kibera.
              </p>
              <div>
                <a
                  href="#"
