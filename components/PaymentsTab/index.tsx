...
import PaymentsTabItem from "./PaymentsTabItem";
import paymentsTabData from "./paymentsTabData";
    ...
    <>
      ...
      <section className="relative pb-20 pt-18.5 lg:pb-22.5">
        <div className="relative mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          >
            {paymentsTabData.map((feature, key) => (
              <div
                className={feature.id === currentTab ? "block" : "hidden"}
                key={key}
              >
                <PaymentsTabItem paymentTab={feature} />
              </div>
            ))}
          </motion.div>
          {/* <!-- Tab Content End --> */}
