...
export const testimonialData: Testimonial[] = [
  ...
  },
  {
    ...
    image: image2,
    content:
      "I am grateful for the support and education provided by Brainstorm Centre. The widow support group has helped my business and  now I managed to build  my house.",
  },
  {
    id: 3,
    name: "Pamela Nabwire",
  ...
  },
  {
    ...
    image: image4,
    content:
      `I trained on business management, financial litracy etc. At the moment I am running my business that I started in 2019 `
  },
];
